...
function initActivePage() {
    ...
    document.querySelectorAll("nav a[href], .mobile-menu a[href]").forEach(link => {
        ...
        const isHome = (current === "" || current === "index.html") && (href === "index.html" || href === "");
...
function initProjectFilters() {
    ...
    const apply = () => {
        ...
        countEl.textContent = query || selectedStatus !== "all"
...
function initRevealOnScroll() {
    ...
    const targets = document.querySelectorAll(".project-card, .about-block, .focus-card");
